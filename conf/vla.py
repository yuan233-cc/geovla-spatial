...
# === GeoVLA-VLA Pretraining Configs ===

@dataclass
class Exp_GeoVLA_OXE_Magic_Soup_Plus_Minus(Exp_SigLIP_224px_Bridge):
...
class VLARegistry(Enum):
    ...
    # === GeoVLA-VLA Pretraining Configs ===
    EXP_GEOVLA_OXE_MAGIC_SOUP_PLUS_MINUS = Exp_GeoVLA_OXE_Magic_Soup_Plus_Minus
