...
def get_vla_dataset_and_collator(
    ...
    **kwargs
    ...
    batch_transform = RLDSBatchTransform(
        ...
        depth_process = kwargs.pop("depth_process", None),
        load_wrist = kwargs.pop("load_wrist", False), proprio_type = kwargs.get("proprio_type", None),
        wrist_first = kwargs.pop("wrist_first", False),
    )
