...
OXE_DATASET_CONFIGS = {
    ...
    **{
        k: {
            ...
            "state_encoding": StateEncoding.POS_QUAT,
            "action_encoding": ActionEncoding.EEF_POS,
        } for k in ["pick_cube", "stack_cube", 
                    "pick_single_ycb", "pick_single_egad", "pick_clutter_ycb", # 以上都是最基本的，只有一个image和action
                    "stack_cube_with_state", # 这个是有state的结果
                    ]
    },
    **{
        k: {
            "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
            "depth_obs_keys": {"primary": "base_depth", "secondary": None, "wrist": None},
            "state_obs_keys": ["state", "goal"],
            "state_encoding": StateEncoding.POS_QUAT,
            "action_encoding": ActionEncoding.EEF_POS,
        } for k in [
                    ############################################
                    "maniskill_with_state_wrist_depth_tcp",
                    ############################################
                    "pick_cube_with_state_wrist_depth_tcp", "stack_cube_with_state_wrist_depth_tcp", 
                    "pick_single_ycb_with_state_wrist_depth_tcp", "pick_single_egad_with_state_wrist_depth_tcp", 
    ...
    **{
        k: {
            "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
            "depth_obs_keys": {"primary": "base_pc", "secondary": None, "wrist": None},
            "state_obs_keys": ["state", "goal"],
            "state_encoding": StateEncoding.POS_QUAT,
            "action_encoding": ActionEncoding.EEF_POS,
        } for k in [
                    ############################################
                    "maniskill_with_state_wrist_pc_tcp",
                    ############################################
                    "pick_cube_with_state_wrist_pc_tcp", "stack_cube_with_state_wrist_pc_tcp", 
                    "pick_single_ycb_with_state_wrist_pc_tcp", "pick_single_egad_with_state_wrist_pc_tcp", 
    ...
    **{
        k: {
            ...
            "action_encoding": ActionEncoding.EEF_POS,
                    ...
                    ############################################
                    "pick_cube_pcd_goal_state", "stack_cube_pcd_goal_state", 
                    "pick_single_egad_pcd_goal_state", "pick_single_ycb_pcd_goal_state", 
                    "pick_clutter_ycb_pcd_goal_state",
                    ############################################
                    ]
    }, 
    ...
    "libero_90_with_state_wrist_depth": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": "base_depth", "secondary": None, "wrist": "wrist_depth"},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.POS_QUAT,
        "action_encoding": ActionEncoding.EEF_POS,
    },

    "libero_90_with_state_wrist_pc_x256": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": "base_pc", "secondary": None, "wrist": "wrist_pc"},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.POS_QUAT,
        "action_encoding": ActionEncoding.EEF_POS,
    },
    ...
    **{k: {
        ...
        "libero_90_with_state_wrist_pc", "libero_10_with_state_wrist_pc",
        "libero_goal_with_state_wrist_pc", "libero_spatial_with_state_wrist_pc",
        "libero_object_with_state_wrist_pc",
    ]},
    ...
    **{k: {
        ...
        "libero_10_state_pc_no_noop", "libero_90_state_pc_no_noop", "libero_goal_state_pc_no_noop",
        "libero_object_state_pc_no_noop", "libero_spatial_state_pc_no_noop"
    ]},
    #################################################################################
    **{
        k: {
            "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "image"},
            "depth_obs_keys": {"primary": "base_depth", "secondary": None, "wrist": "base_depth"},
            "state_obs_keys": ["state", "extrinsic"],
            "state_encoding": StateEncoding.POS_QUAT,
            "action_encoding": ActionEncoding.EEF_POS,
        } for k in ["x4_stack_block_0514", "x4_stack_cup_0516", "x4_stack_circle_0512", # x4老任务
                    "x4_pick_glue_0604", "x4_stack_blue_cup_0603", # no side
                    "x4_pick_carrot_0605", "x4_hang_cup_0606", 
                    "x4_put_basketball5_0609", "x4_put_basketball_0609" # 新数据
                    ]
    }, 

    **{
        k: {
            "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "other_image"},
            "depth_obs_keys": {"primary": "base_depth", "secondary": None, "wrist": "other_depth"},
            "state_obs_keys": ["state", "extrinsic"],
            "state_encoding": StateEncoding.POS_QUAT,
            "action_encoding": ActionEncoding.EEF_POS,
        } for k in ["x1_insert_ring_0509", "x1_push_button_0507", "x1_put_carrot_0507",
                    "x1_put_glue_0506", "x1_slide_block_0509", "x1_stack_cube_0509", "x1_stack_cup_0508", # x1
                    "x4_hang_cup_other0701", "x4_matryoshka_doll_other0617", "x4_put_basketball5_other0617",
                    "x4_stack_cup_other_0704",
                    "x4_pick_out_scissor_other_0701", "x4_pick_hairclip_other0702", # black
                    "x4_stack_block_in_black_background_other0703", # black
                    "x4_insert_shape_other0703"
                    ]
    }, 
}
