...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "maniskill_with_state_wrist_depth_tcp": identity_transform,
    "stack_cube_with_state": identity_transform,
    **{k: identity_transform 
       for k in ["pick_cube", "stack_cube", "pick_single_ycb", "pick_single_egad", "pick_clutter_ycb"]}, 
    **{k: identity_transform 
       for k in ["pick_cube_with_state_wrist_depth_tcp", 
    ...
    **{k: identity_transform 
       for k in ["pick_cube_with_state_wrist_pc_tcp", 
    ...
    **{k:identity_transform
        for k in ["pick_cube_pcd_goal_state", 
                  "stack_cube_pcd_goal_state", 
                  "pick_single_egad_pcd_goal_state", 
                  "pick_single_ycb_pcd_goal_state", 
                  "pick_clutter_ycb_pcd_goal_state",]},
    ### libero datasets
    "libero_10_no_noops": identity_transform,
    "libero_90_with_state_wrist_depth": identity_transform,
    "libero_90_with_state_wrist_pc_x256": identity_transform,
    **{k:identity_transform
       for k in [
           "libero_10_with_state_wrist_pc", "libero_90_with_state_wrist_pc",
    ...
    **{k:identity_transform
        for k in ["x4_stack_block_0514", "x4_stack_cup_0516", "x4_stack_circle_0512", # x4老任务
                  "x4_stack_blue_cup_0603", "x4_pick_glue_0604",
                  "x4_pick_carrot_0605", "x4_hang_cup_0606", "x4_put_basketball_0609", # 新数据
                  "x1_insert_ring_0509", "x1_push_button_0507", "x1_put_carrot_0507",
                  ...
                  "x4_put_basketball5_0609",
                  "x4_pick_out_scissor_other_0701", "x4_pick_hairclip_other0702", 
                  "x4_stack_block_in_black_background_other0703", #  black
                  "x4_stack_cup_other_0704", "x4_insert_shape_other0703"
                    ]},
}
